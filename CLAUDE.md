...
```bash
sonar analyze agentic --project aifred_juice-shop --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project aifred_juice-shop --depth DEEP
```
